...
const home = () => {
  const initialOptions = {
    clientId: 'AaFvnNqoJaHwooclHh84CyBY8Vpa2a2dEV2bQrolD8yUDHmLiRJVDX9cwQv36HBXbVpH8yX_iJaHIKq4',
    currency: "GBP",
    intent: "capture",
  };
  ...
  return (
    <section>
      <div className="flex flex-col gap-16 justify-center items-center p-5 mb-5 font-main text-2xl mt-5 md:flex-row">
        <img
